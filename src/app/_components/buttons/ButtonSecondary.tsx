...
export default function ButtonSecondary({title, css}: ButtonInterface) {
  return (
    ...
    <button 
      type='submit' 
      className={`${css} flex items-center justify-center group cursor-pointer transition-all ease-in-out duration-300 
        bg-gradient-to-br from-amber-400 to-amber-400`}>
